...
/**
 * Hud Produces a hud for the player This shows the number of coins, health,
 * points the player has Also displays time remaining for any powerups collected
 *
...
public class Hud implements Disposable {
	...
	public Hud(SpriteBatch sb) {
		...
		coinMagnetLabel = new Label(String.format("%03f", coinMagnet),
				new Label.LabelStyle(new BitmapFont(), Color.YELLOW));
		speedBoostLabel = new Label(String.format("%03d", (Math.round(speedBoost))),
				new Label.LabelStyle(new BitmapFont(), Color.YELLOW));
		absorptionHeartLabel = new Label(String.format("%03f", absorptionHeart),
				new Label.LabelStyle(new BitmapFont(), Color.YELLOW));
		fasterShootingLabel = new Label(String.format("%03f", fasterShooting),
				new Label.LabelStyle(new BitmapFont(), Color.YELLOW));
		freezeEnemyLabel = new Label(String.format("%03f", freezeEnemy),
				new Label.LabelStyle(new BitmapFont(), Color.YELLOW));
	...
	/**
	 * Update label which displays number of coins Called from GoldShop, when
	 * something has been purchased, to show new balance
	 */
